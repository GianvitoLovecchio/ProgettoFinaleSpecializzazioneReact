...
export default function TagPage_index() {
    ...
    const initialUrl = `https://api.rawg.io/api/games?key=b7b1b42400a549ada462bed213a5844a&tags=${tagName}&page=${currentPage}`;
    ...
    useEffect(() => {
        const newUrl = `https://api.rawg.io/api/games?key=b7b1b42400a549ada462bed213a5844a&tags=${tagName}&page=${currentPage}${sort ? `&ordering=${sort}` : ''}`
        updateUrl(newUrl);
